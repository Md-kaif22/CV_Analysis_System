...
class DynamicRunEvaluator(RunEvaluator):
    ...
    def _coerce_evaluation_results(
        self, results: Union[dict, EvaluationResults], source_run_id: uuid.UUID
    ) -> Union[EvaluationResult, EvaluationResults]:
...
class DynamicComparisonRunEvaluator:
    ...
    def __init__(
        ...
        if afunc:
            afunc = _normalize_comparison_evaluator_func(
                afunc
    ...
    def compare_runs(
        ...
        result = self.func(
            runs, example, langsmith_extra={"run_id": source_run_id, "tags": tags}
        )
