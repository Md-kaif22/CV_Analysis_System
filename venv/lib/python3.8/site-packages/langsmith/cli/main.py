...
class LangSmithCommand:
    ...
    def pull(self, *, version: str = "0.5.7") -> None:
        ...
        subprocess.run(
            [*self.docker_compose_command, "-f", str(self.docker_compose_file), "pull"]
        )
    ...
    def logs(self) -> None:
        ...
        subprocess.run(
            [*self.docker_compose_command, "-f", str(self.docker_compose_file), "logs"]
        )
