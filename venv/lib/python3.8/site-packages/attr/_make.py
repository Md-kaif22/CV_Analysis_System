...
class _ClassBuilder:
    ...
    def add_hash(self):
        self._cls_dict["__hash__"] = self._add_method_dunders(
            _make_hash(
                self._cls, self._attrs, frozen=self._frozen, cache_hash=self._cache_hash
            )
        )
...
def _make_hash(cls, attrs, frozen, cache_hash):
    ...
    def append_hash_computation_lines(prefix, indent):
        ...
        method_lines.extend(
            [indent + prefix + hash_func, indent + f"        {type_hash},"]
        )
...
def _make_init(
    ...
    init = _make_method(
        "__attrs_init__" if attrs_init else "__init__", script, unique_filename, globs
    )
    ...
    for a in attrs:
        ...
        if a.init is False:
            if has_factory:
                ...
                lines.append(
                    fmt_setter(
                        attr_name, f"attr_dict['{attr_name}'].default", has_on_setattr
                    )
                )
