...
class BaseChatModel(BaseLanguageModel[BaseMessage], ABC):
                    ...
                    *[
                        run_manager.on_llm_end(
                            LLMResult(
                                generations=[
                                    res.generations
                                ],  # type: ignore[list-item, union-attr]
    ...
    async def _agenerate_with_cache(
        ...
        **kwargs: Any,
        ...
        if self._should_stream(async_api=True, run_manager=run_manager, **kwargs):
            chunks: List[ChatGenerationChunk] = []
            async for chunk in self._astream(messages, stop=stop, **kwargs):
                chunk.message.response_metadata = _gen_info_and_msg_metadata(chunk)
                if run_manager:
        ...
        **kwargs: Any,
        ...
        while True:
            item = await run_in_executor(
                None, next, iterator, done  # type: ignore[call-arg, arg-type]
            )
            if item is done:
                break
    ...
    def with_structured_output(
        self, schema: Union[Dict, Type], *, include_raw: bool = False, **kwargs: Any
