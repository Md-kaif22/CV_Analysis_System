...
class SimpleResultMetaData(ResultMetaData):
    ...
    def __init__(
        ...
        if extra:
            recs_names = [
                ((name,) + (extras if extras else ()), (index, name, extras))
...
class ResultInternal(InPlaceGenerative, Generic[_R]):
    ...
    def _row_getter(self) -> Optional[Callable[..., _R]]:
        ...
        if tf and not real_result._source_supports_scalars:
            ...
            _make_row_orig: Callable[
                ..., _R
            ] = functools.partial(  # type: ignore  # noqa E501
    ...
    def _allrows(self) -> List[_R]:
        ...
        if self._unique_filter_state:
            ...
            interim_rows = [
                ...
                if sig_row not in uniques
                and not uniques.add(sig_row)  # type: ignore # noqa: E501
            ]
        else:
    ...
    @overload
    def _only_one_row(
        self, raise_for_second_row: bool, raise_for_none: Literal[True], scalar: bool
    ) -> _R:
        ...

    @overload
    def _only_one_row(
        self, raise_for_second_row: bool, raise_for_none: bool, scalar: bool
    ) -> Optional[_R]:
        ...
