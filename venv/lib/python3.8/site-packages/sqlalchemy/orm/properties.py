...
class ColumnProperty(
    _MapsColumns[_T], StrategizedProperty[_T], _IntrospectsAnnotations, log.Identified
):
    ...
    class Comparator(util.MemoizedSlots, PropComparator[_PT]):
        ...
        def operate(
            ...
            return op(
                self.__clause_element__(), *other, **kwargs
        ...
        def reverse_operate(
            ...
            return op(
                col._bind_param(op, other), col, **kwargs
            )  # type: ignore[no-any-return]  # noqa: E501
...
class MappedColumn(_IntrospectsAnnotations, _MapsColumns[_T], _DeclarativeMapped[_T]):
    ...
    def declarative_scan(
        ...
        if self._use_existing_column and decl_scan.inherits and decl_scan.single:
            ...
            column = (
                self.column
            ) = supercls_mapper.local_table.c.get(  # type: ignore[assignment] # noqa: E501
                colname, column
            )
