...
class PathRegistry(HasCacheKey):
    ...
    def _deserialize_path(cls, path: _SerializedPath) -> _PathRepresentation:
        ...
        p = tuple(
            chain(
                *[
                    (_deserialize_mapper_token(mcls), _deserialize_key_token(mcls, key))
...
class TokenRegistry(PathRegistry):
    ...
    def generate_for_superclasses(self) -> Iterator[PathRegistry]:
        ...
        if not parent.is_aliased_class:
            ...
            and cast("AliasedInsp[Any]", parent.entity)._is_with_polymorphic
        ):
            yield self
            for ent in cast(
...
class PropRegistry(PathRegistry):
    ...
    def __init__(self, parent: AbstractEntityRegistry, prop: StrategizedProperty[Any]):
        ...
        if not insp.is_aliased_class or insp._use_mapper_path:  # type: ignore
            ...
            subclass_entity: _InternalEntityType[Any] = parent[-1]._entity_for_mapper(
                prop.parent
