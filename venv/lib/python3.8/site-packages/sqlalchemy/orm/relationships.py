...
_ORMColCollectionElement = Union[
    ColumnClause[Any], _HasClauseElement[Any], roles.DMLColumnRole, "Mapped[Any]"
]
...
class _RelationshipArgs(NamedTuple):
    ...
    secondary: _RelationshipArg[
        Optional[_RelationshipSecondaryArgument], Optional[FromClause]
    ]
    primaryjoin: _RelationshipArg[
        Optional[_RelationshipJoinConditionArgument], Optional[ColumnElement[Any]]
    ]
...
class RelationshipProperty(
        ...
        def _criterion_exists(
            ...
            **kwargs: Any,
            ...
            (
                ...
                dest_selectable=to_selectable, source_selectable=source_selectable
            )
        ...
        def visit_bindparam(bindparam: BindParameter[Any]) -> None:
            if bindparam._identifying_key in bind_to_col:
                bindparam.callable = self._get_attr_w_warn_on_none(
                    mapper, state, dict_, bind_to_col[bindparam._identifying_key]
                )
    ...
    def _setup_entity(self, __argument: Any = None) -> None:
        ...
        if isinstance(argument, str):
            ...
            resolved_argument = cast(
                "_ExternalEntityType[Any]", self._clsregistry_resolve_name(argument)()
            )
    ...
    def _generate_backref(self) -> None:
        ...
        if self.backref is not None and not self.back_populates:
            ...
            if self.secondary is not None:
                ...
                pj = kwargs.pop(
                    "primaryjoin", self._join_condition.secondaryjoin_minus_local
                )
                sj = kwargs.pop(
                    "secondaryjoin", self._join_condition.primaryjoin_minus_local
                )
            else:
                pj = kwargs.pop(
                    "primaryjoin", self._join_condition.primaryjoin_reverse_remote
                )
    ...
    def _create_joins(
        ...
        (
            ...
            source_selectable, dest_selectable, aliased, single_crit, extra_criteria
        )
        if source_selectable is None:
    ...
    def _check_foreign_cols(
        ...
        if self.support_sync and has_foreign and not can_sync:
            err = (
                ...
                "%s join condition "
                "'%s' on relationship %s."
                % (primary and "primary" or "secondary", join_condition, self.prop)
            )
            err += (
                "  Ensure that referencing columns are associated "
        ...
        if aliased:
            if secondary is not None:
                ...
                primary_aliasizer = ClauseAdapter(
                    secondary, exclude_fn=_local_col_exclude
                )
