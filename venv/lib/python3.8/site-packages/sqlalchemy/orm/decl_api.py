...
class _declared_attr_common:
    def __init__(
        self, fn: Callable[..., Any], cascading: bool = False, quiet: bool = False
    ):
        # suppport
        # @declared_attr
        # @classmethod
...
class registry:
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
    ...
    def update_type_annotation_map(
        self, type_annotation_map: _TypeAnnotationMapType
    ) -> None:
    ...
    def map_imperatively(
        self, class_: Type[_O], local_table: Optional[FromClause] = None, **kw: Any
    ) -> Mapper[_O]:
