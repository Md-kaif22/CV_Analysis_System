...
class LoaderCriteriaOption(CriteriaOption):
    ...
    def __init__(
        ...
        entity = cast(
            "_InternalEntityType[Any]", inspection.inspect(entity_or_base, False)
        )
        if entity is None:
    ...
    def process_compile_state_replaced_entities(
        self, compile_state: ORMCompileState, mapper_entities: Iterable[_MapperEntity]
    ) -> None:
    ...
    def __clause_element__(self):
        ...
        return (
            ...
            ._set_propagate_attrs(
                ...
                {"compile_state_plugin": "orm", "plugin_subject": plugin_subject}
            )
        )
...
class _ORMJoin(expression.Join):
    ...
    def __init__(
        ...
        left_info = cast(
            "Union[FromClause, _InternalEntityType[Any]]", inspection.inspect(left)
        )

        right_info = cast(
            "Union[FromClause, _InternalEntityType[Any]]", inspection.inspect(right)
        )
...
def _is_mapped_annotation(
    raw_annotation: _AnnotationScanType, cls: Type[Any], originating_cls: Type[Any]
) -> bool:
    try:
