...
class Query(
    ...
    def _only_full_mapper_zero(self, methname: str) -> Mapper[Any]:
        ...
        return self._raw_columns[0]._annotations[
            "parententity"
        ]  # type: ignore  # noqa: E501
    ...
    @overload
    def as_scalar(self: Query[Tuple[_NOT_ENTITY]],) -> ScalarSelect[_NOT_ENTITY]:
        ...
    ...
    @overload
    def scalar_subquery(self: Query[Tuple[_MAYBE_ENTITY]],) -> ScalarSelect[Any]:
        ...

    @overload
    def scalar_subquery(self: Query[Tuple[_NOT_ENTITY]],) -> ScalarSelect[_NOT_ENTITY]:
        ...
    ...
    def is_single_entity(self) -> bool:
        ...
        return (
            ...
            and isinstance(
                self._raw_columns[0]._annotations["parententity"], ORMColumnsClauseRole
            )
        )
    ...
    @_generative
    def add_entity(
        self, entity: _EntityType[Any], alias: Optional[Union[Alias, Subquery]] = None
    ) -> Query[Any]:
    ...
    def _last_joined_entity(
        ...
        if self._setup_joins:
            return _determine_last_joined_entity(self._setup_joins)
        else:
            return None
    ...
    def join(
        ...
        **Controlling what to Join From**
        ...
        join_target = coercions.expect(
            roles.JoinTargetRole, target, apply_propagate_attrs=self, legacy=True
        )
    ...
    def instances(
        self, result_proxy: CursorResult[Any], context: Optional[QueryContext] = None
    ) -> Any:
    ...
    def _compile_state(self, for_statement: bool = False, **kw: Any) -> ORMCompileState:
        ...
        compile_state_cls = cast(
            ORMCompileState, ORMCompileState._get_plugin_class_for_plugin(stmt, "orm")
        )
...
class BulkDelete(BulkUD):
    ...
    def __init__(self, query: Query[Any], delete_kwargs: Optional[Dict[Any, Any]]):
        super().__init__(query)
