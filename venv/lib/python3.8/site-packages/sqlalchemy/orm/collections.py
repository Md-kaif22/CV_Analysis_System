...
class CollectionAdapter:
    ...
    def fire_pre_remove_event(self, initiator=None, key=NO_KEY):
        ...
        self.attr.fire_pre_remove_event(
            self.owner_state, self.owner_state.dict, initiator=initiator, key=key
        )
...
def _instrument_membership_mutator(method, before, argument, after):
    ...
    if hasattr(method, "_sa_instrument_role"):
        wrapper._sa_instrument_role = (
            method._sa_instrument_role
...
__canned_instrumentation: util.immutabledict[Any, _CollectionFactoryType] = (
    util.immutabledict(
        {list: InstrumentedList, set: InstrumentedSet, dict: InstrumentedDict}
    )
)

__interfaces: util.immutabledict[
    Any, Tuple[Dict[str, str], Dict[str, Callable[..., Any]]]
] = util.immutabledict(
    {
        list: (
