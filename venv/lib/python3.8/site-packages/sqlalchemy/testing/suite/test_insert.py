...
class ReturningTest(fixtures.TablesTest):
    ...
    @testing.combinations(
        ...
        (Numeric(precision=15, scale=12, asdecimal=True), Decimal("8.5514716"), False),
    ...
    def test_insert_w_floats(
        ...
        result = connection.execute(
            t.insert().returning(
                t.c.id, t.c.value, sort_by_parameter_order=bool(sort_by_parameter_order)
            ),
            (
    ...
    @testing.combinations(
        ("non_native_uuid", Uuid(native_uuid=False), uuid.uuid4()),
        (
            "non_native_uuid_str",
        ...
        ("LargeBinary1", LargeBinary(), b"this is binary"),
    ...
    def test_imv_returning_datatypes(
        self, connection, metadata, sort_by_parameter_order, type_, value, multiple_rows
    ):
