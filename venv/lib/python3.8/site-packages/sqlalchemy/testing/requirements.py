...
class SuiteRequirements(Requirements):
    ...
    def sequences(self):
        ...
        return exclusions.only_if(
            [lambda config: config.db.dialect.supports_sequences], "no sequence support"
        )
    ...
    def _running_on_windows(self):
        return exclusions.LambdaPredicate(
            lambda: platform.system() == "Windows", description="running on Windows"
        )
    ...
    def threading_with_mock(self):
        ...
        """
        return exclusions.skip_if(
            lambda config: config.options.has_coverage, "Stability issues with coverage"
        )
