...
class OperatorType(Protocol):
    ...
    @overload
    def __call__(
        self, left: Operators, right: Optional[Any] = None, *other: Any, **kwargs: Any
    ) -> Operators:
        ...

    def __call__(
        self, left: Any, right: Optional[Any] = None, *other: Any, **kwargs: Any
    ) -> Operators:
        ...
...
class Operators:
    ...
    def op(
        ...
        """
        operator = custom_op(
            opstring, precedence, is_comparison, return_type, python_impl=python_impl
        )
    ...
    def bool_op(
        ...
        """
        return self.op(
            opstring, precedence=precedence, is_comparison=True, python_impl=python_impl
        )
...
class custom_op(OperatorType, Generic[_T]):
    ...
    def __call__(
        ...
        if hasattr(left, "__sa_operate__"):
            ...
            return self.python_impl(
                left, right, *other, **kwargs
