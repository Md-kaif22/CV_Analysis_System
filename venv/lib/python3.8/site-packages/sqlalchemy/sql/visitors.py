    ...
    def _generate_compiler_dispatch(cls) -> None:
        ...
        def _compiler_dispatch(self: Visitable, visitor: Any, **kw: Any) -> str:
            ...
            try:
                ...
                return visitor.visit_unsupported_compilation(
                    self, err, **kw
...
def iterate(
    obj: Optional[ExternallyTraversible], opts: Mapping[str, Any] = util.EMPTY_DICT
) -> Iterator[ExternallyTraversible]:
...
@overload
def replacement_traverse(
    obj: _CE, opts: Mapping[str, Any], replace: _TraverseTransformCallableType[Any]
) -> _CE:
    ...
