...
def lateral(
    selectable: Union[SelectBase, _FromClauseArgument], name: Optional[str] = None
) -> LateralFromClause:
...
@overload
def select(
    __ent0: _TCCA[_T0], __ent1: _TCCA[_T1], __ent2: _TCCA[_T2], __ent3: _TCCA[_T3]
...
def values(
    *columns: ColumnClause[Any], name: Optional[str] = None, literal_binds: bool = False
) -> Values:
