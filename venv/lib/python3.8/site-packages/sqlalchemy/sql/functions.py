...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    def columns(
        ...
        str, KeyedColumnElement[Any]
    ]:  # type: ignore[override]  # noqa: E501
    ...
    def over(
        ...
        *,
        ...
        """
        return Over(
            self, partition_by=partition_by, order_by=order_by, rows=rows, range_=range_
        )
    ...
    ) -> ClauseElement:  # type: ignore[override]  # noqa E501
