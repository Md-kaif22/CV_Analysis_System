...
_ForUpdateOfArgument = Union[
    ...
    Union["_ColumnExpressionArgument[Any]", "_FromClauseArgument"],
...
class HasPrefixes:
    ...
    def prefix_with(
        self, *prefixes: _TextCoercedExpressionArgument[Any], dialect: str = "*"
    ) -> Self:
...
class HasSuffixes:
    ...
    def suffix_with(
        self, *suffixes: _TextCoercedExpressionArgument[Any], dialect: str = "*"
    ) -> Self:
...
class HasHints:
    ...
    @_generative
    def with_hint(
        self, selectable: _FromClauseArgument, text: str, dialect_name: str = "*"
    ) -> Self:
    ...
    def _with_hint(
        self, selectable: Optional[_FromClauseArgument], text: str, dialect_name: str
    ) -> Self:
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    def _setup_collections(self) -> None:
        ...
        self._populate_column_collection(
            columns=_columns, primary_key=primary_key, foreign_keys=foreign_keys
        )
...
class Join(roles.DMLTableRole, FromClause):
    ...
    def _populate_column_collection(
        ...
        foreign_keys.update(
            itertools.chain(
                *[col.foreign_keys for col in _columns]
    ...
    def _copy_internals(self, clone: _CloneCallableType = _clone, **kw: Any) -> None:
        ...
        all_the_froms = set(
            itertools.chain(_from_objects(self.left), _from_objects(self.right))
        )
...
class Alias(roles.DMLTableRole, FromClauseAlias):
    ...
    @classmethod
    def _factory(
        cls, selectable: FromClause, name: Optional[str] = None, flat: bool = False
    ) -> NamedFromClause:
...
class TableValuedAlias(LateralFromClause, Alias):
    ...
    def render_derived(
        self, name: Optional[str] = None, with_types: bool = False
    ) -> TableValuedAlias:
...
class CTE(
    ...
    @classmethod
    def _factory(
        cls, selectable: HasCTE, name: Optional[str] = None, recursive: bool = False
    ) -> CTE:
...
class SelectsRows(ReturnsRows):
    ...
    def _generate_columns_plus_names(
        self, anon_for_dupe_key: bool, cols: Optional[_SelectIterable] = None
...
class HasCTE(roles.HasCTERole, SelectsRows):
    ...
    def cte(
        self, name: Optional[str] = None, recursive: bool = False, nesting: bool = False
    ) -> CTE:
        r"""Return a new :class:`_expression.CTE`,
        or Common Table Expression instance.
...
class TableClause(roles.DMLTableRole, Immutable, NamedFromClause):
    ...
    _traverse_internals: _TraverseInternalsType = [
        ("columns", InternalTraversal.dp_fromclause_canonical_column_collection),
...
class GenerativeSelect(SelectBase, Generative):
    ...
    @_generative
    def fetch(
        self, count: _LimitOffsetType, with_ties: bool = False, percent: bool = False
    ) -> Self:
    ...
    def order_by(
        self,
        __first: Union[
            Literal[None, _NoArg.NO_ARG], _ColumnExpressionOrStrLabelArgument[Any]
        ] = _NoArg.NO_ARG,
...
class SelectState(util.MemoizedSlots, CompileState):
    ...
    def __init__(
        self, statement: Select[Any], compiler: Optional[SQLCompiler], **kw: Any
    ):
    ...
    def get_column_descriptions(cls, statement: Select[Any]) -> List[Dict[str, Any]]:
        return [
            {"name": name, "type": element.type, "expr": element}
    ...
    def _column_naming_convention(
        ...
        def go(
            c: Union[ColumnElement[Any], TextClause], col_name: Optional[str] = None
        ) -> Optional[str]:
            if is_text_clause(c):
                return None
            elif TYPE_CHECKING:
        ...
        if froms:
            ...
            if ambiguous_table_name_map is not None:
                ambiguous_table_name_map.update(
                    (fr.name, _anonymous_label.safe_construct(hash(fr.name), fr.name))
                    for item in froms
        ...
        for right, onclause, left, flags in args:
            ...
            if replace_from_obj_index is not None:
                ...
                self.from_clauses = (
                    ...
                    + (Join(left_clause, right, onclause, isouter=isouter, full=full),)
...
class Select(
    ...
    def join(
        ...
        *,
        ...
        self._setup_joins += (
            (join_target, onclause_element, None, {"isouter": isouter, "full": full}),
        )
        return self
    ...
    def join_from(
        ...
        *,
        ...
        self._setup_joins += (
            (join_target, onclause_element, from_, {"isouter": isouter, "full": full}),
        )
        return self
    ...
    def get_children(self, **kw: Any) -> Iterable[ClauseElement]:
        return itertools.chain(
            super().get_children(
                omit_attrs=("_from_obj", "_correlate", "_correlate_except"), **kw
            ),
    ...
    @_generative
    def correlate(
        self, *fromclauses: Union[Literal[None, False], _FromClauseArgument]
    ) -> Self:
        ...
        *,
        ...
        if proxy_compound_columns:
            ...
            prox = [
                ...
                for (
                    (required_label_name, proxy_key, fallback_label_name, c, repeated),
                    extra_cols,
                ) in (zip(self._generate_columns_plus_names(False), extra_col_iterator))
                if is_column_element(c)
            ]
        else:
            prox = [
