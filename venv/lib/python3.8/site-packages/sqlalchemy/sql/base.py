    ...
    def safe_merge(cls, other):
        ...
        if (
            ...
            raise TypeError(
                ...
                % (other, cls, set(other._cache_attrs).difference(cls._cache_attrs))
            )
        return cls + d
...
class Executable(roles.StatementRole):
    ...
    def _add_context_option(
        self, callable_: Callable[[CompileState], None], cache_args: Any
    ) -> Self:
...
class _ColumnMetrics(Generic[_COL_co]):
    ...
    def embedded(
        self, target_set: Union[Set[ColumnElement[Any]], FrozenSet[ColumnElement[Any]]]
    ) -> bool:
...
class DedupeColumnCollection(ColumnCollection[str, _NAMEDCOL]):
    ...
    def replace(
        self, column: _NAMEDCOL, extra_remove: Optional[Iterable[_NAMEDCOL]] = None
    ) -> None:
