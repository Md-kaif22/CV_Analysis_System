...
_CacheKeyTraversalDispatchTypeReturn = Sequence[
    Tuple[
        str,
        Any,
        Union[Callable[..., Tuple[Any, ...]], CacheTraverseTarget, InternalTraversal],
    ]
]
            ...
            if obj is not None:
                ...
                # if they are empty
                    ...
                    if meth is CACHE_IN_PLACE:
                        ...
                        if (
                            self._gen_static_annotations_cache_key
                        ):  # type: ignore  # noqa: E501
                            result += (
                                self._annotations_cache_key
                            )  # type: ignore  # noqa: E501
                        else:
                            result += self._gen_annotations_cache_key(
                                anon_map
                            )  # type: ignore  # noqa: E501
...
class _CacheKeyTraversal(HasTraversalDispatch):
    ...
    def visit_table_hint_list(
        ...
        return (
            ...
            tuple(
                [
                    (clause._gen_cache_key(anon_map, bindparams), dialect_name, text)
