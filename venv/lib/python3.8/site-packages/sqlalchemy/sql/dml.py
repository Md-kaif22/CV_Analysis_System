...
class ValuesBase(UpdateBase):
    ...
    _multi_values: Tuple[
        Union[Sequence[Dict[_DMLColumnElement, Any]], Sequence[Sequence[Any]]], ...
    ] = ()
    ...
    def values(
        self, *args: Union[_DMLColumnKeyMapping[Any], Sequence[Any]], **kwargs: Any
    ) -> Self:
...
class Insert(ValuesBase):
    ...
    _traverse_internals = (
        [
            ...
            ("_return_defaults_columns", InternalTraversal.dp_clauseelement_tuple),
