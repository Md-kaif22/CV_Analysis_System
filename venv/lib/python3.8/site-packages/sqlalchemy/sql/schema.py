...
def _copy_expression(
    ...
    return cast(
        ColumnElement[Any], visitors.replacement_traverse(expression, {}, replace)
    )
...
class Table(DialectKWArgs, HasSchemaAttr, TableClause, inspection.Inspectable["Table"]):
    ...
    def tometadata(
        ...
        return self.to_metadata(
            metadata, schema=schema, referred_schema_fn=referred_schema_fn, name=name
        )
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    def _get_colspec(
        self,
        schema: Optional[
            Union[str, Literal[SchemaConst.RETAIN_SCHEMA, SchemaConst.BLANK_SCHEMA]]
        ] = None,
    ...
    def __init__(
        ...
        *columns: _DDLColumnArgument,
        ...
        if processed_expressions is not None:
            ...
            for (expr, _, _, add_element) in coercions.expect_col_expression_collection(
...
class CheckConstraint(ColumnCollectionConstraint):
    ...
    @_document_text_coercion(
        "sqltext", ":class:`.CheckConstraint`", ":paramref:`.CheckConstraint.sqltext`"
    )
    def __init__(
        self,
    ...
    def _autoincrement_column(self) -> Optional[Column[int]]:
        ...
        if len(self._columns) == 1:
            ...
            if col.autoincrement is True:
                ...
                return col
            elif col.autoincrement in ("auto", "ignore_fk") and _validate_autoinc(
                col, False
            ):
                return col
            else:
