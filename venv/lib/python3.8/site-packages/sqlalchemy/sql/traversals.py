    ...
    for cls in util.walk_subclasses(target_hierarchy):
        if hasattr(cls, "_generate_cache_attrs") and hasattr(
            ...
            _copy_internals.generate_dispatch(
                cls, cls._traverse_internals, "_generated_copy_internals_traversal"
            )
            _get_children.generate_dispatch(
                cls, cls._traverse_internals, "_generated_get_children_traversal"
            )
...
class HasShallowCopy(HasTraverseInternals):
    ...
    def _generate_shallow_copy(
        cls, internal_dispatch: _TraverseInternalsType, method_name: str
    ...
    def _shallow_from_dict(self, d: Dict[str, Any]) -> None:
        ...
        try:
            ...
            shallow_from_dict = self._generate_shallow_from_dict(
                cls._traverse_internals, "_generated_shallow_from_dict_traversal"
            )

            cls._generated_shallow_from_dict_traversal = (
                shallow_from_dict
    ...
    def _shallow_to_dict(self) -> Dict[str, Any]:
        ...
        try:
            ...
            cls._generated_shallow_to_dict_traversal = (
                shallow_to_dict
            )  # type: ignore  # noqa: E501
...
class TraversalComparatorStrategy(HasTraversalDispatch, util.MemoizedSlots):
    ...
    def __init__(self):
        self.stack: Deque[
            Tuple[Optional[ExternallyTraversible], Optional[ExternallyTraversible]]
        ] = deque()
        self.cache = set()
    ...
    def compare(
        self, obj1: ExternallyTraversible, obj2: ExternallyTraversible, **kw: Any
    ) -> bool:
        stack = self.stack
        cache = self.cache
