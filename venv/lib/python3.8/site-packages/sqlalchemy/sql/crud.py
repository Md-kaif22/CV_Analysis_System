    ...
    **kw: Any,
    ...
    if _compile_state_isinsert(compile_state) and compile_state._has_multi_parameters:
        ...
        multi_extended_values = _extend_values_for_multiparams(
            ...
            stmt,
            compile_state,
            cast("Sequence[_CrudParamElementStr]", values),
...
@overload
def _create_bind_param(
    compiler: SQLCompiler, col: ColumnElement[Any], value: Any, **kw: Any
) -> str:
    ...
...
def _key_getters_for_crud_column(
    ...
    if dml.isupdate(compile_state) and compile_state._extra_froms:
        ...
        _getattr_col_key = _col_bind_name = operator.attrgetter(
            "key"
...
def _append_param_parameter(
    ...
    if coercions._is_literal(value):
        ...
        value = compiler.process(
            value.self_group(), accumulate_bind_names=accumulated_bind_names, **kw
        )
        ...
        if compiler.dialect.supports_sequences and (
            ...
            values.append(
                (
                    ...
                    compiler.preparer.format_column(c),
                    compiler.process(
                        c.default, accumulate_bind_names=accumulated_bind_names, **kw
                    ),
                    accumulated_bind_names,
                )
            )
    ...
    if c.onupdate is not None and not c.onupdate.is_sequence:
        if c.onupdate.is_clause_element:
            values.append(
                (
                    c,
                    compiler.preparer.format_column(c, use_table=include_table),
...
@overload
def _create_insert_prefetch_bind_param(
    compiler: SQLCompiler, c: ColumnElement[Any], process: Literal[False], **kw: Any
