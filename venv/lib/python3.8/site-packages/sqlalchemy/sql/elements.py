...
@overload
def literal(
    value: _T, type_: None = None, literal_execute: bool = False
) -> BindParameter[_T]:
    ...
...
def literal(
    ...
    return coercions.expect(
        roles.LiteralValueRole, value, type_=type_, literal_execute=literal_execute
    )
...
class ClauseElement(
    ...
    def unique_params(
        self, __optionaldict: Optional[Dict[str, Any]] = None, **kwargs: Any
    ) -> Self:
    ...
    def params(
        self, __optionaldict: Optional[Mapping[str, Any]] = None, **kwargs: Any
    ) -> Self:
        """Return a copy with :func:`_expression.bindparam` elements
        replaced.
...
class SQLCoreOperations(Generic[_T_co], ColumnOperators, TypingOnly):
    ...
    if typing.TYPE_CHECKING:
        ...
        def __eq__(
            self, other: Any
        ) -> ColumnElement[bool]:  # type: ignore[override]  # noqa: E501
            ...
        ...
        def in_(
            self, other: Union[Iterable[Any], BindParameter[Any], roles.InElementRole]
        ) -> BinaryExpression[bool]:
            ...
        ...
        def startswith(
            self, other: Any, escape: Optional[str] = None, autoescape: bool = False
        ) -> ColumnElement[bool]:
            ...
...
class ColumnElement(
    ...
    def operate(
        ...
        return op(
            self.comparator, *other, **kwargs
        )  # type: ignore[no-any-return]  # noqa: E501

    def reverse_operate(
        self, op: operators.OperatorType, other: Any, **kwargs: Any
    ) -> ColumnElement[Any]:
        return op(
            other, self.comparator, **kwargs
        )  # type: ignore[no-any-return]  # noqa: E501
...
class TextClause(
    ...
    def columns(
        self, *cols: _ColumnExpressionArgument[Any], **types: _TypeEngineArgument[Any]
    ) -> TextualSelect:
...
class BooleanClauseList(ExpressionClauseList[bool]):
    ...
    def or_(
        ...
        *clauses: _ColumnExpressionArgument[bool],
        ...
        """
        return cls._construct(
            operators.or_, False_._singleton, True_._singleton, initial_clause, *clauses
        )
...
class Cast(WrapsColumnExpression[_T]):
    ...
    def __init__(
        self, expression: _ColumnExpressionArgument[Any], type_: _TypeEngineArgument[_T]
    ):
...
class BinaryExpression(OperatorExpression[_T]):
    ...
    if typing.TYPE_CHECKING:
        ...
        def __invert__(self: BinaryExpression[_T],) -> BinaryExpression[_T]:
            ...
...
class Slice(ColumnElement[Any]):
    ...
    def __init__(self, start, stop, step, _name=None):
        self.start = coercions.expect(
            roles.ExpressionElementRole, start, name=_name, type_=type_api.INTEGERTYPE
        )
        self.stop = coercions.expect(
            roles.ExpressionElementRole, stop, name=_name, type_=type_api.INTEGERTYPE
        )
        self.step = coercions.expect(
            roles.ExpressionElementRole, step, name=_name, type_=type_api.INTEGERTYPE
        )
...
class Over(ColumnElement[_T]):
    ...
    def __reduce__(self):
        return (
            self.__class__,
            (self.element, self.partition_by, self.order_by, self.range_, self.rows),
        )

    def _interpret_range(
        self, range_: typing_Tuple[Optional[_IntOrRange], Optional[_IntOrRange]]
...
class WithinGroup(ColumnElement[_T]):
    ...
    def over(
        ...
        *,
        ...
        """
        return Over(
            self, partition_by=partition_by, order_by=order_by, range_=range_, rows=rows
        )
...
class FunctionFilter(Generative, ColumnElement[_T]):
    ...
    def over(
        ...
        partition_by: Optional[
            Union[
                Iterable[_ColumnExpressionArgument[Any]], _ColumnExpressionArgument[Any]
            ]
        ] = None,
        order_by: Optional[
            Union[
...
class Label(roles.LabeledColumnExprRole[_T], NamedColumn[_T]):
    ...
    def __init__(
        ...
        element = coercions.expect(
            roles.ExpressionElementRole, element, apply_propagate_attrs=self
        )
    ...
    def _apply_to_inner(
        self, fn: Callable[_PS, ColumnElement[_T]], *arg: _PS.args, **kw: _PS.kwargs
    ) -> Label[_T]:
...
class CollationClause(ColumnElement[str]):
    ...
    def _create_collation_expression(
        ...
        return BinaryExpression(
            expr, CollationClause(collation), operators.collate, type_=collate_type
        )
