...
def _expression_collection_was_a_list(
    attrname: str, fnname: str, args: Union[Sequence[_T], Sequence[Sequence[_T]]]
) -> Sequence[_T]:
...
@overload
def expect(
    role: Type[roles.LiteralValueRole], element: Any, **kw: Any
) -> BindParameter[Any]:
    ...
...
@overload
def expect(
    role: Type[roles.DDLReferredColumnRole], element: Any, **kw: Any
...
@overload
def expect(
    role: Type[roles.DDLConstraintColumnRole], element: Any, **kw: Any
) -> Union[Column[Any], str]:
    ...
...
@overload
def expect(
    role: Type[roles.StatementOptionRole], element: Any, **kw: Any
...
@overload
def expect(
    role: Type[roles.DMLTableRole], element: _DMLTableArgument, **kw: Any
) -> _DMLTableElement:
    ...
...
@overload
def expect(
    role: Type[roles.SelectStatementRole], element: SelectBase, **kw: Any
) -> SelectBase:
    ...
...
@overload
def expect(
    role: Type[roles.FromClauseRole], element: _FromClauseArgument, **kw: Any
) -> FromClause:
    ...
...
@overload
def expect(
    role: Type[roles.ColumnsClauseRole], element: _ColumnsClauseArgument[Any], **kw: Any
...
@overload
def expect(
    role: Type[roles.JoinTargetRole], element: _JoinTargetProtocol, **kw: Any
) -> _JoinTargetProtocol:
    ...
...
def expect_col_expression_collection(
    role: Type[roles.DDLConstraintColumnRole], expressions: Iterable[_DDLColumnArgument]
) -> Iterator[
    Tuple[
...
class RoleImpl:
    ...
    def _implicit_coercions(
        self, element: Any, resolved: Any, argname: Optional[str] = None, **kw: Any
    ) -> Any:
    ...
    def _implicit_coercions(
        ...
        **kw,
        ...
        return elements.BindParameter(
            None, element, type_=type_, unique=True, literal_execute=literal_execute
        )
    ...
    def _literal_coercion(self, element, *, expr, operator, **kw):
        if util.is_non_string_iterable(element):
            non_literal_expressions: Dict[
                Optional[_ColumnExpressionArgument[Any]], _ColumnExpressionArgument[Any]
            ] = {}
