...
_RefCollectionToListenerType = Dict[
    "weakref.ref[RefCollection[Any]]", "weakref.ref[_ListenerFnType]"
]
...
_collection_to_key: Dict[
    weakref.ref[RefCollection[Any]], _ListenerToEventKeyType
] = collections.defaultdict(dict)
"""
...
class _EventKey(Generic[_ET]):
    ...
    def append_to_list(
        self, owner: RefCollection[_ET], list_: Deque[_ListenerFnType]
    ) -> bool:
