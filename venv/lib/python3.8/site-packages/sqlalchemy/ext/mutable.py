...
class MutableBase:
    ...
    def _listen_on_attribute(
        ...
        event.listen(
            parent_cls, "_sa_event_merge_wo_load", load, raw=True, propagate=True
        )
...
class Mutable(MutableBase):
    ...
    def as_mutable(cls, sqltype: _TypeEngineArgument[_T]) -> TypeEngine[_T]:
        ...
        def listen_for_type(
            mapper: Mapper[_T], class_: Union[DeclarativeAttributeIntercept, type]
        ) -> None:
            if mapper.non_primary:
                return
    ...
    def changed(self) -> None:
        ...
        for parent, key in self._parents.items():
            ...
            for value, attr_name in zip(
                prop._composite_values_from_instance(self), prop._attribute_keys
            ):
...
class MutableList(Mutable, List[_T]):
    ...
    *values themselves* inside the list. Therefore it is not a sufficient
    ...
    def __iadd__(
        self, x: Iterable[_T]
    ) -> MutableList[_T]:  # type: ignore[override,misc] # noqa: E501
        self.extend(x)
        return self
...
class MutableSet(Mutable, Set[_T]):
    ...
    *values themselves* inside the set. Therefore it is not a sufficient
    ...
    ) -> MutableSet[_T]:  # type: ignore[override,misc] # noqa: E501
        self.update(other)
        return self
    ...
    ) -> MutableSet[_T]:  # type: ignore[misc] # noqa: E501
