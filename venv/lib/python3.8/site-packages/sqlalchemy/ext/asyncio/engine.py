...
@util.create_proxy_methods(
    ...
    classmethods=[],
    methods=[],
    attributes=["closed", "invalidated", "dialect", "default_isolation_level"],
)
class AsyncConnection(
    ProxyComparable[Connection], StartableContext["AsyncConnection"], AsyncConnectable
):
    ...
    def __init__(
        self, async_engine: AsyncEngine, sync_connection: Optional[Connection] = None
    ):
...
def _no_insp_for_async_conn_yet(subject: AsyncConnection,) -> NoReturn:  # noqa: U100
...
def _no_insp_for_async_engine_xyet(subject: AsyncEngine,) -> NoReturn:  # noqa: U100
    raise exc.NoInspectionAvailable(
