...
_lookup: Dict[str, Tuple[int, Set[str]]] = {
    "Column": (COLUMN, {"sqlalchemy.sql.schema.Column", "sqlalchemy.sql.Column"}),
    ...
    "registry": (
        REGISTRY,
        {"sqlalchemy.orm.decl_api.registry", "sqlalchemy.orm.registry"},
    ),
    "ColumnProperty": (
        COLUMN_PROPERTY,
        {
    ...
    "MapperProperty": (
        MAPPER_PROPERTY,
        {"sqlalchemy.orm.interfaces.MapperProperty", "sqlalchemy.orm.MapperProperty"},
    ),
    ...
    "mapped": (
        MAPPED_DECORATOR,
        {"sqlalchemy.orm.decl_api.registry.mapped", "sqlalchemy.orm.registry.mapped"},
    ),
    "as_declarative": (
        AS_DECLARATIVE,
        {
    ...
    "declared_attr": (
        DECLARED_ATTR,
        {"sqlalchemy.orm.decl_api.declared_attr", "sqlalchemy.orm.declared_attr"},
    ),
    "declarative_mixin": (
        DECLARATIVE_MIXIN,
        {
