...
class MySQLCompiler(compiler.SQLCompiler):
    ...
    def visit_typeclause(self, typeclause, type_=None, **kw):
        ...
        if isinstance(type_, sqltypes.TypeDecorator):
            ...
            type_, (sqltypes.DECIMAL, sqltypes.DateTime, sqltypes.Date, sqltypes.Time)
        ):
...
class MySQLDDLCompiler(compiler.DDLCompiler):
    def get_column_specification(self, column, **kw):
        ...
        is_timestamp = isinstance(
            column.type._unwrapped_dialect_impl(self.dialect), sqltypes.TIMESTAMP
        )
...
class MySQLDialect(default.DefaultDialect):
    ...
    construct_arguments = [
        ...
        (
            sa_schema.Index,
            {"using": None, "length": None, "prefix": None, "with_parser": None},
        ),
    ]

    def __init__(
        self, json_serializer=None, json_deserializer=None, is_mariadb=None, **kwargs
    ):
    ...
    def has_sequence(self, connection, sequence_name, schema=None, **kw):
        ...
        cursor = connection.execute(
            ...
            dict(name=str(sequence_name), schema_name=str(schema)),
        )
