...
class _OracleNumeric(sqltypes.Numeric):
    ...
    def _cx_oracle_outputtypehandler(self, dialect):
        ...
        def handler(cursor, name, default_type, size, precision, scale):
            ...
            return cursor.var(
                type_, 255, arraysize=cursor.arraysize, outconverter=outconverter
            )
                ...
                if bindparam.isoutparam:
                    ...
                    if hasattr(type_impl, "_cx_oracle_var"):
                        ...
                        if isinstance(type_impl, _LOBDataType):
                            ...
                            out_parameters[name] = self.cursor.var(
                                decimal.Decimal, arraysize=len_params
                            )
    ...
    def _generate_connection_outputtype_handler(self):
        ...
        def output_type_handler(cursor, name, default_type, size, precision, scale):
            ...
            # cx_Oracle should return Unicode
                ...
                return cursor.var(
                    str, size, cursor.arraysize, **dialect._cursor_var_unicode_kwargs
                )
                ...
                return cursor.var(
                    cx_Oracle.DB_TYPE_RAW, _CX_ORACLE_MAGIC_LOB_SIZE, cursor.arraysize
                )
