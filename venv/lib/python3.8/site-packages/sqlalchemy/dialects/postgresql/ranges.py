...
class Range(Generic[_T]):
        ...
        def __init__(
            ...
            *,
            ...
            self.__dict__.update(
                {"lower": lower, "upper": upper, "bounds": bounds, "empty": empty}
            )
    ...
    def _upper_edge_adjacent_to_lower(
        self, value1: Optional[_T], bound1: str, value2: Optional[_T], bound2: str
    ) -> bool:
    ...
    def difference(self, other: Range[_T]) -> Range[_T]:
        ...
        if sl_vs_ol <= 0 and su_vs_ol >= 0 and su_vs_ou <= 0:
            ...
            if (
                ...
                return Range(
                    slower, olower, bounds=cast(_BoundsType, slower_b + rupper_b)
                )
        ...
        if sl_vs_ol >= 0 and su_vs_ou >= 0 and sl_vs_ou <= 0:
            ...
            if (
                ...
                return Range(
                    oupper, supper, bounds=cast(_BoundsType, rlower_b + supper_b)
                )
