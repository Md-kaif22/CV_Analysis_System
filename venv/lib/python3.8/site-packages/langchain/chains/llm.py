...
@deprecated(
    since="0.1.17", alternative="RunnableSequence, e.g., `prompt | llm`", removal="1.0"
)
class LLMChain(Chain):
    ...
    def apply(
        ...
        run_manager = callback_manager.on_chain_start(None, {"input_list": input_list})
        try:
