...
def _load_stuff_chain(
    ...
    **kwargs: Any,
    ...
    llm_chain = LLMChain(
        llm=llm, prompt=prompt, verbose=verbose
...
def _load_map_reduce_chain(
    ...
    **kwargs: Any,
    ...
    map_chain = LLMChain(
        llm=llm, prompt=question_prompt, verbose=verbose
    )  # type: ignore[arg-type]
    _reduce_llm = reduce_llm or llm
    reduce_chain = LLMChain(
        llm=_reduce_llm, prompt=combine_prompt, verbose=verbose
    )  # type: ignore[arg-type]
...
def _load_refine_chain(
    ...
    **kwargs: Any,
    ...
    refine_chain = LLMChain(
        llm=_refine_llm, prompt=refine_prompt, verbose=verbose
    )  # type: ignore[arg-type]
