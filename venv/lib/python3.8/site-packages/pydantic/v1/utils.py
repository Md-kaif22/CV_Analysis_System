...
def unique_list(
    input_list: Union[List[T], Tuple[T, ...]], *, name_factory: Callable[[T], str] = str
) -> List[T]:
    """
...
def smart_deepcopy(obj: Obj) -> Obj:
    ...
    if obj_type in IMMUTABLE_NON_COLLECTIONS_TYPES:
        return (
            obj
        )  # fastest case: obj is immutable and not collection therefore will not be copied anyway
    try:
...
def get_discriminator_alias_and_values(
    ...
    if is_union(get_origin(tp)):
        ...
        return (
            tp.__fields__[discriminator_key].alias,
            all_literal_values(t_discriminator_type),
        )
