...
_loadtxt_with_like = array_function_dispatch(_loadtxt_dispatcher, use_like=True)(
    loadtxt
)
...
_genfromtxt_with_like = array_function_dispatch(_genfromtxt_dispatcher, use_like=True)(
    genfromtxt
)
