...
def readfortrancode(ffile, dowithline=show, istop=1):
    ...
    if istop:
        ...
        gotnextfile, filepositiontext, currentfilename, sourcecodeform, strictf77, beginpattern, quiet, verbose, dolowercase = (
            saveglobals
        )
...
endpattern = (
    re.compile(beforethisafter % ("", groupends, groupends, r".*"), re.I),
    "end",
)
endifs = (
    r"end\s*(if|do|where|select|while|forall|associate|block|" + r"critical|enum|team)"
)
endifpattern = (
